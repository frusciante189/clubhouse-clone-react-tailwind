...
const Navbar = () => {
  ...
  return (
    <div className="bg-[#221f14] text-[#f1efe3] w-full font-medium">
      <div className="max-w-screen-lg mx-auto flex items-center">
        <div className="flex w-full px-5 lg:px-0 py-8 md:py-10">
          <div className="flex flex-col md:flex-row flex-1 items-center justify-center md:justify-start">
            <div className="md:mr-6">
              <div className="md:-mt-2 w-48">
                <a href="/">
                  <svg class="w-full fill-current" viewBox="0 0 640 118">
            ...
            <div
              className={`${
                open ? "md:flex items-center text-center text-lg" : "hidden"
              }`}
            >
              <div className="md:ml-3 lg:ml-8 mt-10 md:mt-0">
                <a
                  href="/"
                  className="p-5 hover:text-yellow-500 transition-colors transform duration-300"
                >
                  Blog
                </a>
              </div>
          ...
          <div className="ml-6 md:flex items-center justify-end cursor-pointer hidden relative">
            <div className="flex items-center justify-end">
              <img
                src="https://www.joinclubhouse.com/static/img/homepage/qr_code_light.5eed4efad9f3.png"
                alt=""
                className="object-contain h-10"
              />
              <span className="ml-6">Get Clubhouse</span>
            </div>
          </div>
          <div className="md:hidden">
            <span className="absolute right-4 -mt-1">
              <MenuIcon
